...
async function options() {
    ...
    if (option === "Withdraw") {
        ...
        console.log("Thank you, your current account balance will be updated soon...");
    }
    else if (option === "Check Balance") {
        const SysgenAmnt = Math.floor(Math.random() * 10000);
        ...
        console.log("Thank you, your request is in process you will soon receive a notification about your request");
    }
}
